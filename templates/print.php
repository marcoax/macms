<?php
    ...
    include_once($_SERVER['DOCUMENT_ROOT'].'/config/configure.php');
...
<page backtop="40mm" backbottom="14mm" backleft="0mm" backright="0mm" style="font-size: 10pt">
    <page_header>
       <table class="page_header">
            <tr>
                <td style="text-align: center;width: 100%;background: #DADADA;padding:1.3mm;border:0px solid;">
             ...
             <tr style="text-align: center;">
			    <td style="padding:3mm;border:0px solid;background-color: #FFFFFF;"><img class="" id="logo-header" src="<?php echo DIR_WS_IMAGES?>/logo-printA4.png" alt="La Moderna Cartotecnica srl - Panettone"></td>
		     </tr>
        </table>
    </page_header>
    <page_footer>
        <table class="page_footer">
            <tr>
                <td style="width: 100%; text-align: left;border:0px solid;background-color: #FFFFFF;">
    ...
    <div  style="padding:15px 0px 0px 15px;background: #DADADA;margin-bottom:7mm">
		<table style="width: 95%;padding:0mm">
			<tr >
				<td style="width: 50%; text-align: left; padding-right:20px;border:0px solid;font-size: 10pt;background-color: #DADADA;" valign="top">
					<h1 style="color:#A81729"><?php echo stripslashes( $objPage->Name )?></h1>
					<?php echo  stripslashes($objPage->Descrizione )?>	
				</td>
	    		<td style="width: 50%; text-align: left;border:0px solid;background-color: #DADADA;" valign="top">
	...
	<?php if(strlen($objPage->Intro)>15):?>
